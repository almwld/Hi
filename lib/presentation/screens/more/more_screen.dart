        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          GridView.count(
            ...
            children: [
              ...
              _serviceItem(context, Icons.local_hospital, 'مستشفيات', AppColors.teal, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const InteractiveMapScreen(type: 'hospitals')))),
              ...
              _serviceItem(context, Icons.local_pharmacy, 'صيدلية', AppColors.success, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const InteractiveMapScreen(type: 'pharmacies')))),
          ...
          _menuItem(context, Icons.calendar_month, 'حجز مستشفى', 'احجز موعد في أقرب مستشفى', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const HospitalBookingScreen()))),
          ...
          _menuItem(context, Icons.cake, 'حاسبة الولادة', 'موعد الولادة المتوقع', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const DueDateCalculatorScreen()))),
          ...
          _menuItem(context, Icons.monitor_heart, 'تتبع السكر', 'قراءات الجلوكوز', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const GlucoseTrackerScreen()))),
          _menuItem(context, Icons.psychology, 'مقياس التوتر', 'قِس مستوى توترك', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const StressMeterScreen()))),
          _menuItem(context, Icons.diamond, 'طب الأسنان', 'خدمات ونصائح للأسنان', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const DentalCareScreen()))),
          ...
          _menuItem(context, Icons.monitor_weight, 'تتبع الوزن', 'وزنك وBMI والهدف', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const WeightTrackerScreen()))),
          _menuItem(context, Icons.favorite, 'أطباء مفضلين', 'قائمة أطبائك', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const FavoriteDoctorsScreen()))),
